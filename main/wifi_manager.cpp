...
extern char mqtt_user[16];
extern char mqtt_password[32];

extern String wifi_ssid;
//extern String wifi_password[32];
...
int connectWiFi(){
  ...
  WiFiManagerParameter custom_mqtt_user("user", "user name", mqtt_user, 16);
  ...
  //set config portal time out to 3min
